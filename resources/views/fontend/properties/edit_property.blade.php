                ...
                <div class="search-area">
                    <div class="search-area-inner">
                        <div class="search-contents ">
                            ...
                            @endif
                            {!! Form::open(['route' => ['property.update', $properties->id], 'method' => 'PUT', 'files' => true]) !!}
                            <h3 class="heading">{{ __('label.basic_information') }}</h3>
                            <div class="row">
                                <div class="col-lg-12 ">
                                    <div class="form-group name">
                                        {!! Form::label('name', __('label.property_title')) !!}
                                        {!! Form::text('name', $properties->name, ['class' => 'form-control', 'placeholder' => __('label.property_title')]) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('address', $properties->address, ['class' => 'form-control', 'placeholder' => __('label.address')]) !!}
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('price', $properties->price, ['class' => 'form-control', 'placeholder' => __('label.property_title')]) !!}
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="form-group">
                               ...
                               <div class="col-lg-3 col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('acreage', $properties->acreage, ['class' => 'form-control', 'placeholder' => __('label.acreage')]) !!}
                                    <span>m2</span>
                                </div>
                            </div>
                            <div class="col-lg-12">
